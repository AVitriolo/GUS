rule get_K_closest_CpGs_plotting_purposes:
    ...
    conda:
        "../envs/bedtools.yml"
    log:
        "logs/get_K_closest_CpGs_plotting_purposes/get_K_closest_CpGs_plotting_purposes_{assembly_code}_v{gencode_version}_{tss_subset}_{minCount_expr}_{minSamples_expr}_{K_closest}.log"
    shell:
        """
