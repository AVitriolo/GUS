rule subset_beta_matrix:
    ...
    input:
        ...
        betas="resources/CpG_data/beta/{assembly_code}_{comparison_type}_{sample_type}_{leftCount_beta}_{rightCount_beta}_{minSamples_beta}_{minCov}.txt"
    log:
    ...
    shell:
        ...
        grep -F -f {input.patterns} {input.betas} >> {output} 2>> {log}
        """
