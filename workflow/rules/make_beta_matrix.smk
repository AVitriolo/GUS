rule make_beta_matrix:
    output:
        beta="resources/CpG_data/{current_date}_{assembly_code}_CpGs_beta_{comparison_type}_{sample_type}_{leftCount_beta}_{rightCount_beta}_{minSamples_beta}.txt",
        CpGs="resources/CpG_data/{current_date}_{assembly_code}_CpGs_coord_{comparison_type}_{sample_type}_{leftCount_beta}_{rightCount_beta}_{minSamples_beta}.bed"
    input:
