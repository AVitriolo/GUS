rule generate_datasets:
    ...
    input:
        subsetted_beta="data/{current_date}_{assembly_code}_CpGs_beta_{sample_type}_{leftCount_beta}_{rightCount_beta}_{minSamples_beta}_filtered_{comparison_type}_v{gencode_version}_{tss_subset}_{distance}_{min_CpG}_subsetted_{TxID}",
