rule unpack_RSE:
    ...
    log:
        "logs/unpack_RSE/unpack_RSE_{assembly_code}_{sample_type}_v{gencode_version}_{tss_subset}_{distance}_{min_CpG}_{minCount_expr}_{minSamples_expr}_{K_closest}_{TxID}.log"
    shell:
        """
